...
The cameras, labeled as C1 and C2, were installed in July 2021 approximately at \SI{\sim230}{\meter} and \SI{\sim350}{\meter} from the terminal ice cliff respectively, with a strongly convergent pose~\figref{fig:4:studyarea}.
...
\begin{figure}[ht!]
  ...
  \caption{(a) Picture of the monitoring unit prototype installed for tests at the Belvedere Glacier site. (b) Picture of the final installation of the camera installed on the stream-wise right moraine.}
...
The second UAV flight, UAV-B, was carried out on 05/08/2022 with a DJI Phantom
...
To this end, we used LAMMA \citep{Dematteis2022} and the cosine similarity applied to orientation images as a correlation function (see \secref{sec:3:method_velocity}).
