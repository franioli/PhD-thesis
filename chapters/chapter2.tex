...
The number of points in each PCD and the average volumetric density (i.e., the number of points per unit of volume) of each dense cloud is summarized in \tabref{tab:2:pcd_stats}.
