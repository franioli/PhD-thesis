...
Volume variations between these surveys were calculated using a DOD approach and subsequently converted into ice mass variations  (\figref{fig:3:cumulative_volumes_mass}). 
