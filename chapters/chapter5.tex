...
\begin{figure}[ht]
  ...
  \subcaptionbox{\label{fig:5:rotations:1}}{
    \includegraphics[width=.6\textwidth]{dim_rotations_1.png}
  } \\
  \subcaptionbox{\label{fig:5:rotations:2}}{
    \includegraphics[width=.6\textwidth]{dim_rotations_2.png}
  }
...
\begin{figure}
  ...
  \subcaptionbox{\label{fig:5:stereo_res:1}}{
    \includegraphics[width=14cm]{stereo_ms_matches}
  }\\
  \subcaptionbox{\label{fig:5:stereo_res:2}}{
    \includegraphics[height=14cm]{stereo_colmap_matches}
  }\\
...
\begin{figure}
  ...
  \subcaptionbox{\label{fig:5:stereo_dense:1}}{
    \includegraphics[width=14cm]{winter_dense_ms}
  }\\
  \subcaptionbox{\label{fig:5:stereo_dense:2}}{
    \includegraphics[height=14cm]{stereo_dense_from_sp+lg}
  \caption{}
...
\begin{figure}
  ...
  \subcaptionbox{\label{fig:5:winter_res:1}}{
    \includegraphics[height=3.5cm]{winter_metashape_sparse}
  }
  \subcaptionbox{\label{fig:5:winter_res:2}}{
    \includegraphics[height=3.5cm]{winter_splg}
  }\\
  \subcaptionbox{\label{fig:5:winter_res:3}}{
    \includegraphics[height=3.5cm]{winter_dense_ms}
  }
  \subcaptionbox{\label{fig:5:winter_res:3}}{
    \includegraphics[height=3.5cm]{winter_roma}
  }  
  \caption{}
